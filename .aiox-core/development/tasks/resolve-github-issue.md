...
steps:
  ...
  3_handle_edge_cases:
    ...
    known_pitfalls:
      - Email addresses inside strings may match rename patterns (Issue #159: security@sinkra/aiox-core.dev)
...
- **Pitfall:** `@sinkra/aiox-core` inside email `security@sinkra/aiox-core.dev` was corrupted
